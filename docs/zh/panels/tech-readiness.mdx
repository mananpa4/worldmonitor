---
title: "科技准备度指数"
description: "国家层面的科技准备度排名，行带国旗标签，数据来源于 Economic service。每 6 小时刷新。"
---
...
- `@/services/economic` 中的 `getTechReadinessRankings()` — 封装 Economic service 的科技准备度 RPC。
...
**免费。** 两个变体注册中均无 `premium` 标志。Economic service RPC 是公开的。

## API 参考

- [Economic service](/api/EconomicService.openapi.yaml) — 涵盖科技准备度排名 RPC 和更广泛的宏观指标族。
