...
description: "动态客户端注册、授权和令牌交换端点,支撑 WorldMonitor MCP 服务器。"
---
...
**响应**:`{ "client_id": "c_01HX...", "client_id_issued_at": 1713456789, ... }`
...
所有令牌端点响应均包含 `Cache-Control: no-store, Pragma: no-cache`。
